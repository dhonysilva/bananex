defmodule BananexWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BananexWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BananexWeb.Gettext, "errors", msg, opts)
    end
  end
